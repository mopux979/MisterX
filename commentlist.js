...
var urlMyAvatar = 'http://1.bp.blogspot.com/-O5uDCfQAOuo/XGxlrzKveiI/AAAAAAAAIqk/6MInfzWAZ40Bkm_IhCLSMab5TZWXmml6ACK4BGAYYCw/s1600/ava.png',
    urlMyProfile = 'https://www.blogger.com/profile/04691611567477314717',
...
function showRecentComments(a) {
    ...
    for (var i = 0; j < numRecentComments && i < a.feed.entry.length; i++) {
        ...
        if (c["thr$in-reply-to"]) {
            ...
            var p = "";
            if (h == 'MotoMgz' || h == 'The News of MotoGp World Championship. News, race, results and calendar.') p = " admin";
            ...
            d += '<a class="del" href="https://www.blogger.com/delete-comment.g?blogID=6669587626921570411&postID=' + e.split('#c')[1] + '" target="_blank" title="Delete this comment">×</a></li>'
        }
